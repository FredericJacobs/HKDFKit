...
//! Project version number for HKDFKit-iOS.
FOUNDATION_EXPORT double HKDFKit_iOSVersionNumber;

//! Project version string for HKDFKit-iOS.
FOUNDATION_EXPORT const unsigned char HKDFKit_iOSVersionString[];
